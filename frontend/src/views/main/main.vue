    ...
    <div id="page-wrapper">
      ...
      <div id="header-wrapper">
        ...
        <section id="hero" class="container">
          ...
          <ul class="actions">
            <li>
              <button class="button" @click="goRecruit()">
                스터디 참여하기
              </button>
            </li>
          </ul>
        ...
        <div class="container">
          <div class="row">
            <section class="col-6 col-12-narrower feature">
              ...
              <p>
                구루미에는 다양한 주제 스터디가 운영되고 있어요<br />
                함께 공부할 스터디 친구를 만나보세요
              </p>
              <ul class="actions">
                <li><a href="#" class="button">스터디 모집하기</a></li>
              </ul>
            </section>
            <section class="col-6 col-12-narrower feature">
              ...
              <p>
                구루미에는 다양한 주제 스터디가 운영되고 있어요<br />함께 공부할
                스터디 친구를 만나보세요
              </p>
              <ul class="actions">
                <li><a href="#" class="button">나의 면접 관리</a></li>
              </ul>
            </section>
          </div>
        </div>
      ...
      <div id="promo-wrapper">
        <h2 style="margin-bottom:30px">지원하신 기업이 있다면 검색해보세요.</h2>
        <section id="promo">
          <h2>찾고 있는 스터디가 있다면 검색해보세요.</h2>
          <a href="#" class="button">면접 스터디 검색</a>
        </section>
      </div>
      ...
      <div class="wrapper">
        <section class="container">
          <header class="major">
            <h2>면접 준비, 왜 InterVenience일까요?</h2>
            <p>
              개발자부터 프로덕트 매니저, 마케터까지 IT 취업에 특화된 부트캠프를
              소개합니다.
            </p>
          </header>
          <div class="row features">
            <section class="col-3 col-12-narrower feature">
              ...
              <h4>첫째 고르고!</h4>
              <p>
                친구들과 우리끼리!<br />마음 맞는 사람들과 다 함께<br />실시간
                라이브 스터디까지 원하는 대로<br />취향 저격 맞춤 스터디
              </p>
            </section>
            <section class="col-3 col-12-narrower feature">
              <div class="image-wrapper">
              ...
              <h4>둘째 몰입하고!</h4>
              <p>
                과몰입 스터디<br />오늘은 어떤 컨셉으로 공부할까?<br />다양한
                테마 영상을 고르는 재미<br />실감나게 몰입하는 공부
              </p>
            </section>
            <section class="col-3 col-12-narrower feature">
              <div class="image-wrapper">
              ...
              <h4>셋째 기록하고!</h4>
              <p>
                모두의 스터디 기록<br />내 스터디 관리와 기록<br />우리의 스터디
                시간과 랭킹까지!<br />기록하는 공부
              </p>
            </section>
            <section class="col-3 col-12-narrower feature">
              ...
              <h4>넷째</h4>
              <p>실시간 온라인 학습으로 환경의 제약 없이 배워요</p>
            </section>
          </div>
...
#header-wrapper {
  ...
  background-image: url("images/overlay.png"), url("images/header.svg"),
    -moz-linear-gradient(75deg, #ff7088 15%, #f2b69d 55%);
  background-image: url("images/overlay.png"), url("images/header.svg"),
    -webkit-linear-gradient(75deg, #ff7088 15%, #f2b69d 55%);
  background-image: url("images/overlay.png"), url("images/header.svg"),
    -ms-linear-gradient(75deg, #ff7088 15%, #f2b69d 55%);
  background-image: url("images/overlay.png"), url("images/header.svg"),
    linear-gradient(75deg, #ff7088 15%, #f2b69d 55%); */
  /* background-image: url("~@/assets/images/interview7.jpeg"); */
  background-size: cover;
  /* background-size: cover; */
  /* background-image: url("../../assets/images/interview7.jpeg") -moz-linear-gradient(75deg, #ff7088
        15%, #f2b69d 55%); */
...
@media screen and (max-width: 736px) {
  ...
  #navPanel {
    ...
    -ms-transition: -ms-transform 0.5s ease;
    transition: transform 0.5s ease;
    /* background-image: url("images/overlay.png"), url("images/navPanel.svg"),
      -moz-linear-gradient(top, rgba(255, 255, 255, 0), rgba(0, 0, 0, 0.25));
    background-image: url("images/overlay.png"), url("images/navPanel.svg"),
      -webkit-linear-gradient(top, rgba(255, 255, 255, 0), rgba(0, 0, 0, 0.25));
    background-image: url("images/overlay.png"), url("images/navPanel.svg"),
      -ms-linear-gradient(top, rgba(255, 255, 255, 0), rgba(0, 0, 0, 0.25));
    background-image: url("images/overlay.png"), url("images/navPanel.svg"),
      linear-gradient(top, rgba(255, 255, 255, 0), rgba(0, 0, 0, 0.25)); */
    display: block;
    left: 0;
    overflow-y: auto;
    position: fixed;
