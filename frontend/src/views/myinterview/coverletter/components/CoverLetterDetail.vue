  ...
  <div class="plus-container">
    ...
    <div v-if="currentResume.length !=0 " >
      ...
      <div class="cover-inner">
        <h3>자소서 질문</h3>
        <input type="text" v-model="currentResume[selectedNum].question" id="cover-write" />
        <!-- <input type="textarea" v-model="currentResume[selectedNum].answer"/> -->
        <h3>질문 내용</h3>
        <textarea name="" id="cover-write" cols="30" rows="10" v-model="currentResume[selectedNum].answer" ></textarea>
